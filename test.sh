#python3 main.py --db_name imdb --query_dir our_dataset/queries --algs true_rank \
#--losses qerr,join-loss --sampling_priority_alpha 2.0 --max_epochs 10 \
#--query_templates 1a -n 1

python3 main.py --db_name imdb --query_dir our_dataset/queries --algs random \
--losses qerr,join-loss --sampling_priority_alpha 2.0 --max_epochs 10 \
--query_templates 1a -n 1
python3 main.py --db_name imdb --query_dir our_dataset/queries --algs random \
--losses qerr,join-loss --sampling_priority_alpha 2.0 --max_epochs 10 \
...
python3 main.py --db_name imdb --query_dir our_dataset/queries --algs nn \
--losses qerr,join-loss --sampling_priority_alpha 0.0 --max_epochs 10 \
--query_templates 1a -n 1
